...
<head>
  ...
  <body>
                ...
                <ul class="nav product-list">
                  <li>
                    <div class="product-thumbnail">
                      <img src="/user/images/shop/2.jpg" alt="">
                    </div>
                  ...
                  <li>
                    <div class="product-thumbnail">
                      <img src="/user/images/shop/5.jpg" alt="">
                    </div>
                    <div class="product-summary">
    ...
    <section class="page-title parallax">
      <div data-parallax="scroll" data-image-src="{{ asset($single->feature_image) }}" class="parallax-bg"></div>
      <div class="parallax-overlay">
        <div class="centrize">
          <div class="v-center">
            <div class="container">
              <div class="title center">
                <h1 class="upper"><span class="red-dot">{{ $single->title }}</span></h1>
                <h4> {{date("F j, Y, g:i a",strtotime($single->created_at)) }}</h4>
                <hr>
              </div>
            </div>
            <!-- end of container-->
        ...
        <div class="row">
          <div class="col-md-8">
            <article class="post-single">
              <div class="post-info">
                <h2><a href="#">{{ $single->title }}</a></h2>
                <h6 class="upper"><span>By</span><a href="#"> {{ $single->user_find->name }}</a><span class="dot"></span><span>{{date("F j, Y, g:i a",strtotime($single->created_at)) }}</span><span class="dot"></span>
              ...
              <div class="post-media">
                <img src="{{asset($single->feature_image)  }}" alt="">
              </div>
              <div class="post-body">
                <p>
                  {!! htmlspecialchars_decode($single->content) !!}
                </p>
              </div>
            </article>
            <!-- end of article-->
